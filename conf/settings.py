...
# additional string.)
SECRET_KEY = 'itvnz+^gyou4#h)@rw80&4lkb=q9o4yg+-1d=n-=dlj=3uk!fn63v-itvn'
SITE_SETTINGS_KEY = 'itvnz+^gyou4#h)@rw80&4lkb=heritier+-1d=n-=dlj=3uk!fn63v-itvn'
...
DATABASES['default']['PASSWORD'] = 'itvn@tendenci'
